...
public class DiscoveryProfileHandler
{
     ...
     */
    public DiscoveryProfileHandler(DiscoveryProfileService discoveryProfileService,
                                                     ...
                                                     Handler<AsyncResult<Void>> resultHandler)
    {
        ...
        {
            logger.error("Error in validateCredentialProfileIdsExist: {}", exception.getMessage());
