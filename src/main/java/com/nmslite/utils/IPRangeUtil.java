...
public class IPRangeUtil {
    ...
    private static List<String> expandIPRange(String ipRange) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Failed to expand IP range: " + ipRange, e);
        }
    ...
    /**
     * Count the number of IPs in a range without expanding it
     * 
     * @param ipAddress The IP address or range string
     * @param isRange Flag indicating if this should be treated as a range
     ...
     * @throws IllegalArgumentException if the format is invalid
     */
    public static int countIPs(String ipAddress, boolean isRange) {
        if (!validateIPFormat(ipAddress, isRange)) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Failed to count IPs in range: " + ipAddress, e);
        }
    }
}
